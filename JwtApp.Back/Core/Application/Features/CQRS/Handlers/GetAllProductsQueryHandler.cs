...
namespace JwtApp.Back.Core.Application.Features.CQRS.Handlers
{
    public class GetAllProductsQueryHandler : IRequestHandler<GetAllProductsQueryRequest, List<ProductListDto>>
    {
        ...
        public async Task<List<ProductListDto>> IRequestHandler<GetAllProductsQueryRequest, List<ProductListDto>>.Handle(GetAllProductsQueryRequest request, CancellationToken cancellationToken)
        {
